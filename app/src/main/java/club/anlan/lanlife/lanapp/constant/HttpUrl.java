package club.anlan.lanlife.lanapp.constant;
...
public class HttpUrl {
    ...
    public static final String BASE_URl = "http://182.254.215.204:8800";
    ...
    // 保存位置信息
    public static final String SAVE_LOCATION = "/basic/user/saveLocation";
}
